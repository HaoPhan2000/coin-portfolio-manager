...
import 'package:flutter_application_1/network/request_add_transaction.dart';
...
class _MyWidgetState extends State<AddTransaction> {
  ...
  Future addTransaction() async {
    transaction = {
      "coin": widget.idCoinFromDB,
      "price": purchasePrice,
      "total": total,
      "type": selectionType,
      "time": selectionDateTime
    };
    NetworkRequestAddTransaction networkRequestAddTransaction =
        NetworkRequestAddTransaction(jsonBody: transaction);
    await networkRequestAddTransaction.fetchPosts();

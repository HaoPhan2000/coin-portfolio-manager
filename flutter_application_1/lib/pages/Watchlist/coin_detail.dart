...
import 'package:flutter_application_1/pages/Watchlist/chart.dart';

class CoinDetailWatchList extends StatefulWidget {
  const CoinDetailWatchList({
    super.key,
  ...
  @override
  State<CoinDetailWatchList> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<CoinDetailWatchList> {
 ...
 Future deleteWatchList()async {
   ...
   await networkRequestDeleteWatchList.fetchPosts();
    setState(() {
      isWatchList = !isWatchList;
    });
  }

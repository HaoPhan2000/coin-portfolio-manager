...
class CheckUserPortfolio extends StatefulWidget {
  const CheckUserPortfolio(
      {super.key, required this.listCoin, required this.idUser});
  final List listCoin;
  final String idUser;
  @override
  State<CheckUserPortfolio> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<CheckUserPortfolio> {
  @override
  Widget build(BuildContext context) {
    if (widget.idUser.isEmpty == true) {
      ...
      return Portfolio(listCoin: widget.listCoin,idUser: widget.idUser,);
    }
  }
}
